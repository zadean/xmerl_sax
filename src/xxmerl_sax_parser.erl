...
%% Created :  4 Jun 2008
%%----------------------------------------------------------------------
-module(xxmerl_sax_parser).

%%----------------------------------------------------------------------
%% Include files
%%----------------------------------------------------------------------
-include("xxmerl_sax_parser.hrl").
...
stream(Xml, Options, InputType) when is_list(Xml), is_list(Options) ->
    ...
    dtd ->
        xxmerl_sax_parser_list:parse_dtd(Xml,
                        State#xmerl_sax_parser_state{encoding = list,
                                     input_type = InputType});
    normal ->
        xxmerl_sax_parser_list:parse(Xml,
                    State#xmerl_sax_parser_state{encoding = list,
                                     input_type = InputType})
    end;
